...
export default function WebFooter() {
    return (
        <div id="footer" className="border-t-stone-500 border-t-4 bg-stone-700 text-white pt-4">
            <div id="footer-nav" className="container mb-2 flex xs:flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row leading-8 gap-5">
            ...
            <div id="footer-social" className="bg-stone-900 text-center">
                <div className="container flex flex-row w-full justify-center align-middle gap-5 text-lg [&>*]:transition-all [&>*]:duration-1000 [&>*]:ease-in-out [&>*]:hover:bg-stone-950">
